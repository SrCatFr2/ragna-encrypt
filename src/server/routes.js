...
function setupRoutes() {
    ...
    router.post('/v1',  Cybersource, v1RouteHandler.handle.bind(v1RouteHandler));
    router.post('/v2',  CyberV2, v2RouteHandler.handle.bind(v2RouteHandler));
    router.post('/payeezy',  Payeezy, payeezyhndlr.handle.bind(payeezyhndlr));
    router.post('/vantiv',  Vantiv, vantivhndlr.handle.bind(vantivhndlr));
    router.post('/adyen',  Adyen, adyenhndlr.handle.bind(adyenhndlr));
    router.post('/clover',  Clover, cloverhndlr.handle.bind(cloverhndlr));
    ...
    router.get('/clover', (req, res) => {
        res.sendFile(path.join(__dirname, '../public/clover.html'));
    });
